...
for file in file_dir:
    ...
    matchedCard = detect_CNN.process_image(PATH + file)
...
np.savetxt('result/CNN_Result.csv', arr_result, fmt="%s", delimiter=",")
np.savetxt('result/CNN_Metrics.csv', arr_metrics, fmt="%s", delimiter=",")
